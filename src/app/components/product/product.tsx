  ...
  return (
    <div
      className={`
        ...
        ${plan.featured ? 'bg-rose-50 border-2 border-red-200 shadow-xl shadow-red-100/60' : 'bg-white border border-gray-100 shadow-md shadow-gray-100'}
      `}
    >
      {/* Icon + Plan Name */}
      <div className="flex items-center gap-2">
        <h3 className="text-3xl tracking-tight text-gray-800">{plan.name}</h3>
        {plan.badge && (
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-gray-500 text-[15px] mb-15">
            Kelola Inventaris Secara Real-Time Dengan Teknologi QR & RFIQ Dalam
            Satu Platform Terintegrasi. Kurangi Kesalahan Picking Hingga 99% Dan
            Pastikan Stok Selalu Aman Tanpa Ribet.
          </p>
        </div>
