    ...
    <section className="w-full bg-white py-24 px-6">
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-500 text-[15px] font-light max-w-xl mx-auto mt-5 leading-7">
          Pelajari Cara Mengelola Inbound, Outbound, Dan Inventaris
          Secara Efisien Dalam Tampilan Yang Intuitif.
        </p>
          ...
          <div className="relative">
            ...
            <div className="space-y-20">
              ...
              {timelineData.map((item, index) => (
                <div
                  key={index}
                  className={`relative flex items-center ${item.position === "left"
                    ? "md:justify-start"
                    : "md:justify-end"
                    } justify-center`}
                >
                  ...
                  {/* Card */}
                  <div
                    className={`w-full md:w-[42%] bg-white rounded-3xl shadow-lg border border-gray-100 p-7 hover:-translate-y-2 transition-all duration-300 ${item.position === "left"
                      ? "md:mr-auto"
                      : "md:ml-auto"
                      }`}
                  >
